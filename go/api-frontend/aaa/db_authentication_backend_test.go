...
// Tests are commented out since api_user isn't used in PF anymore since 8.2
// Tests have been left in place in case a future release reintroduces the DB auth backend
// jsemaan@inverse.ca
